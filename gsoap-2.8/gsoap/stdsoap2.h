...
// james: 100614 version control.
#define WITH_NOIO
#define WITH_OPENSSL
#define WITH_LEAN
// james: 130118 soap_dom_add_element failed for use WITH_NOIDREF.
#define WITH_NOIDREF
...
#define SOAP_INVALID_SOCKET ((SOAP_SOCKET)-1)
	...
	// james: 110513 modify for IO.
#if 0
#define soap_valid_socket(n) 1
#else
...
// james: 101012 modify SOAP_BUFLEN
#if 1
#  define SOAP_BUFLEN (40*1024)
#else
...
// james: 101117 add GSOAP_CMD_ERR.
typedef enum _GSOAP_CMD_ERR
{
	GSOAP_CMD_OK															= 1,
	GSOAP_CMD_SYSTEM_REBOOT									= 2,
	GSOAP_CMD_ERROR													= 0,
	GSOAP_CMD_MEMORY_ERROR										= -1,
	GSOAP_CMD_VERIFY_ERROR										= -2,
} GSOAP_CMD_ERR;

typedef int (*GSOAP_CB)(void *pPrivate, char *pchMsg, void *pReqData, void *pResData);
...
//#endif
  ...
  unsigned short httpcmd;
  // james: 100628 add descri buffer.
  char chDescri[1024];
  // james: 100701 no respond.
  int IsNoNeedRespond;
  // james: 100630 add ONVIF_CMD_ERR.
  GSOAP_CMD_ERR gsoap_cmd_err;

  // james: 100518 add GSOAP_CB.
  GSOAP_CB gsoap_cb;
  void *pPrivate;
};
...
extern void soap_dom_add_element(struct soap_dom_element *head, struct soap_dom_element *elt);
extern struct soap_dom_element *make_dom_element(struct soap *soap, const char *nstr, const char *name, const char *data);
extern void soap_dom_add_attribute(struct soap_dom_element *elt, struct soap_dom_attribute *att);
extern struct soap_dom_attribute *make_dom_attribute(struct soap *soap, const char *nstr, const char *name, const char *data);
extern void av_soap_allocate(struct soap **soap, void *user_data);
extern void av_soap_deallocate(struct soap *soap);
